...
return [
    ...
    "Bank Name" => "Bank Name",
    "Tether" => "Tether",
    "Crypto Wallet Name" => "Crypto Wallet Name",
    ...
    "Trading Account To Trading Account" => "Trading Account To Trading Account",
    "Current Cash Wallet Balance" => "Current Cash Wallet Balance",
    "Trading Account To Transfer" => "Trading Account To Transfer",
    "Trading Account To Receive" => "Trading Account To Receive",
    "Filter By Date" => "Filter By Date",
    "Select Trading Account No" => "Select Trading Account No.",
...
//    "USDT Protocol Type" => "USDT Protocol Type",
    ...
    "Terms 1" => "I acknowledge I have read and understood the Risk Warning Notice which is provided online as part of this application. I understand that Key Information Documents are available to me on the LuckyAnt Trading (“LuckyAnt Trading”) website.",
    ...
    "Terms 3" => "I understand that LuckyAnt Trading will not provide me with any investment advice on transactions entered into on its platform(s).",
    "Terms 4" => "I also confirm that I have read, understood and agree to be bound by LuckyAnt Trading Privacy Policy.",
    ...
    "Terms 6" => "I confirm that the information provided by me and inserted in this form is correct and that I acknowledge that I shall be obliged to inform LuckyAnt Trading immediately in case of any changes to this information.",
    "Terms 7" => "I confirm that I have acted in my own name as specified in this application and not on behalf of a third party in respect of all matters related to this client relationship. Accordingly, all funds to be deposited and traded in on the account with LuckyAnt Trading are my own funds.",
    "Terms 8" => "I have read, understood and agreed to be bound by LuckyAnt Trading's Deposit And Withdrawals Policy.",
    ...
    "Successful Transfer QCG Wallet To Trading Account!" => "Successful Transfer QCG Wallet To Trading Account!",
    "Successful Transfer Trading Account To QCG Wallet!" => "Successful Transfer Trading Account To QCG Wallet!",
    "Successfully Transfer Trading Account to Trading Account" => "Successfully Transfer Trading Account to Trading Account",
    ...
    "QCG Wallet To Trading Account" => "QCG Wallet To Trading Account",
    "Trading Account To QCG Wallet" => "Trading Account To QCG Wallet",
    "Search By Trading Account No" => "Search By Trading Account No",
    "Trading Account No" => "Trading Account No.",
    "Deposit To Trading Account" => "Deposit To Trading Account",
    "Withdrawal From QCG Wallet" => "Withdrawal From QCG Wallet",
