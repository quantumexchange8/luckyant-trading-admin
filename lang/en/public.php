...
return [
    ...
    'change_password_terms_1' => "Master Password must contain one uppercase letter",
    'change_password_terms_2' => "Master Password must contain one lowercase letter",
    'change_password_terms_3' => "Master Password must contain one number",
    'bank' => "Bank",
    ...
    "master_trading_account" => "Master Trading Account",
    "copy_trade_balance" => "Copy Trade Balance",
    ...
    "remove_admin_confirmation" => "Are you sure you want to remove this admin?",
    "remove_admin_success" => "Successfully removed admin",
    "assign_user" => "Assign User",
    "user" => "User",
    "assign_user_note" => "Note: The selected user will have the rights to access this portal.",
    "is_admin" => "Admin selected",
