    ...
    >
        <div class="flex flex-col border border-gray-200 dark:border-gray-700 rounded-md p-4 gap-2">
            <div class="flex gap-2 items-center">
                <div class="flex justify-center items-center rounded-full bg-primary-400 grow-0 shrink-0 w-10 h-10">
            ...
            <div class="border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
