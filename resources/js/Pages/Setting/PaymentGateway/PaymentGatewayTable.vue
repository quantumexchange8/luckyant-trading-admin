...
const getResults = async () => {
    ...
    try {
        const response = await axios.get('/setting/getPaymentGateways');
...
<template>
    ...
    >
        <DataTable
            ...
            :paginator="paymentGateways?.length > 0"
            removableSort
            dataKey="id"
            :rows="10"
        ...
        >
            ...
            <template v-if="paymentGateways.length">
                ...
                >
                    ...
                    <template #body="slotProps">
                        <span class="uppercase">{{ slotProps.data.platform }}</span>
                    </template>
                </Column>
                <Column
