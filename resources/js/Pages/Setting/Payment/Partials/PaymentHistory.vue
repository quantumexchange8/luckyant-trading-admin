...
const refreshDeposit = ref(refresh);
const historyLoading = ref(isLoading);
...
const getResults = async (page = 1, search = '', date = '') => {
    ...
    try {
        let url = `/setting/getPaymentHistory?page=${page}`;
...
<div class="p-6 mt-10 bg-white rounded-md shadow-md dark:bg-gray-900">
