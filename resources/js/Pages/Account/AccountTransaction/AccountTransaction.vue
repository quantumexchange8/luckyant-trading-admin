...
import AccountTransactionTable from "@/Pages/Account/AccountTransaction/AccountTransactionTable.vue";
...
const tabs = ref([
    {
        ...
        type: 'BalanceIn',
        value: '0',
        component: h(AccountTransactionTable)
    },
    {
        title: 'balance_out',
        type: 'BalanceOut',
...
const selectedType = ref('BalanceIn');
...
<template>
    <AuthenticatedLayout :title="$t('public.transaction_report')">
        <template #header>
            <div class="text-xl font-semibold leading-tight">
                {{ $t('public.transaction_report') }}
            </div>
        </template>
