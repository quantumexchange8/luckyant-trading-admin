...
const loadLazyData = (event) => {
    ...
    try {
        setTimeout(async () => {
            ...
            const url = route('account.getAccountTransactionHistory', params);
...
watch(() => props.selectedType, (newValue) => {
    filters.value['type'].value = newValue;
});
...
const exportReport = () => {
    ...
    const url = route('account.getAccountTransactionHistory', params);  // Construct the export URL
                ...
                >
                    ...
                    <template v-if="transactions?.length > 0">
                        ...
                        >
                            ...
                            <template #body="slotProps">
                                <div v-if="slotProps.data.to_wallet">
                        ...
                        >
                            ...
                            <template #body="slotProps">
                                ...
                                <Tag
                                    :severity="slotProps.data.fund_type === 'RealFund' ? 'info' : 'secondary'"
                                    :value="slotProps.data.fund_type === 'RealFund' ? $t('public.real') : $t('public.demo')"
                                />
                            </template>
                        </Column>
                        <Column
        ...
        <div class="flex flex-col items-center gap-4 divide-y dark:divide-gray-700 self-stretch">
            ...
            <div class="flex flex-col gap-3 items-start w-full pt-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center gap-1 self-stretch">
                    ...
                    <div class="text-gray-950 dark:text-white text-sm font-medium">
                        <Tag
                            :severity="detail.fund_type === 'RealFund' ? 'info' : 'secondary'"
                            :value="detail.fund_type === 'RealFund' ? $t('public.real') : $t('public.demo')"
                        />
                    </div>
                </div>
                <div class="flex flex-col md:flex-row md:items-center gap-1 self-stretch">
